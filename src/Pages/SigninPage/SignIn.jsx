      ...
      <div className="SignIn-Container d-flex align-items-center justify-content-center flex-column">
        ...
        <Form className="SignInform">
          <Form.Group className="mb-4 mt-4 " controlId="formBasicEmail">
            <Form.Control style={{ borderRadius: "10px", border: "2px solid #B6C6E5" }} type="text" placeholder="Email / Username" />
          </Form.Group>

          <div className="d-flex flex-column">
            <Form.Group className="mb-4" controlId="formBasicPassword">
              <Form.Control style={{ borderRadius: "10px", border: "2px solid #B6C6E5" }} variant="secondary" type={values.showPassword ? "text" : "password"} placeholder="Password" />
