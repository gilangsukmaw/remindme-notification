...
function ForgotPassword(props) {
  ...
  function ForgotPassword(props) {
    ...
    const SendForgotPassword = async (e) => {
      ...
      try {
        const res = await axios.post(
          `https://remindme.gabatch13.my.id/api/v1/auth/forgot`,
          state,
    ...
    return (
      <>
        <Modal
          className="ForgotPasword shadow"
          {...props}
          size="lg"
        ...
        >
          ...
          >
            <h1 style={{ fontWeight: "600" }} className="">
              Forgot Password?
            </h1>
          </Modal.Title>
  ...
  return (
    <div
      ...
      style={{ outline: "none", outlineColor: "none", outlineBorder: "none" }}
    >
      <button
        id="ButtonPassword"
        style={{
