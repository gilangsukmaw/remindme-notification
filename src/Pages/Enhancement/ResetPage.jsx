...
function ResetPage() {
  ...
  const handleClickShowPassword1 = () => {
    setnewPassword1({
      ...newPassword1,
      showPassword: !newPassword1.showPassword,
    });
  };
  const handleClickShowPassword2 = () => {
    setnewPassword2({
      ...newPassword2,
      showPassword: !newPassword2.showPassword,
    });
  };
  ...
  const SendResetPassword = async (e) => {
    try {
      const res = await axios.post(
        `https://remindme.gabatch13.my.id/api/v1/auth/forgot/${token}`,
        update
      );
      // setForgotShow(false);
      // console.log(res)
        ...
        <Col className="boxReset" style={{}}>
          ...
          <div className="">
            ...
            <input
              ...
              type={newPassword1.showPassword ? "text" : "password"}
              className="input-Edit"
              onChange={(e) =>
                setUpdate({ ...update, new_password: e.target.value })
              }
            />
            <Button
              style={{
          ...
          <div className="label password-confirm">
            ...
            <input
              ...
              id="password"
              style={{ background: "none" }}
              type={newPassword2.showPassword ? "text" : "password"}
              className="input-Edit"
              onChange={(e) =>
                setUpdate({ ...update, confirm_password: e.target.value })
              }
            />
            <Button
              style={{
          ...
          {update.confirm_password.length > 0 &&
          update.new_password.length > 0 ? (
            <button className="ButtonUngu" onClick={SendResetPassword}>
              Reset Password
            </button>
          ) : null}
        </Col>
