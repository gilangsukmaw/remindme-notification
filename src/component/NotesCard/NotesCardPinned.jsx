...
<>
    ...
    <div className='CardContainer text-dark ' style={{backgroundColor:`${color}`}}>
        <div className='CardTittle d-flex flex-row justify-content-between'>
            <p>Understanding Business Value</p> <img src={Pin}></img>
        </div>
        <div className='CardTanggal'>
            ...
            <div className='ColorPicker'>
                    <Button style={{backgroundColor:'#FFBCC2'}} onClick={()=> setColor('#FFBCC2')}></Button>
                    <Button style={{backgroundColor:'#FCF3A1'}} onClick={()=> setColor('#FCF3A1')}></Button>
                    <Button style={{backgroundColor:'#B1A8FF'}} onClick={()=> setColor('#B1A8FF')}></Button>
                    <Button style={{backgroundColor:'#FF8888'}} onClick={()=> setColor('#FF8888')}></Button>
                    <Button style={{backgroundColor:'#CCF0D7'}} onClick={()=> setColor('#CCF0D7')}></Button>
                </div>
    </div>
