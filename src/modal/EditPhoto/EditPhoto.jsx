                        ...
                        <div className="edit__button">
                            ...
                            <div className="edit__add">
                                <button className="position-relative" onClick={()=> setPhotoGalleryShow(true)}>
                                    <img src={background} alt="" />
                                    <img className="position-absolute top-50 start-50 translate-middle" src={addGallery}
                                        alt="" />
                                        ...
                                        onChange={(e) => setState({image: e.target.files[0]})} required />
...
<div className='EditPhotoButton d-flex flex-column' style={{}}>
    ...
    <Button id='ButtonPhoto' variant="outline-light" style={{}} onClick={()=> setEditPhotoShow(true)}>
        <img src={edit} style={{width:'12.5rem', }} alt="edit">

        </img>
        <div style={{color:'White',marginTop:'-2.5rem'}} className='AddProgressText'>Edit Photo</div>
