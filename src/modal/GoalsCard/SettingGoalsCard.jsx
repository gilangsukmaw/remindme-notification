...
import { Col, Form, Button, FormControl, InputGroup, SplitButton, Dropdown} from 'react-bootstrap';
    ...
    <div className='SetGoalsContainer shadow text-dark' >
        <Form>
            ...
            <div className='d-flex justify-content-center'>
                <Button type="submit" className='mt-3' style={{width:'90%', fontWeight:'700',height:'3rem', borderRadius:'35px'}} variant='warning'>Save</Button>
            </div>
        </Form>
